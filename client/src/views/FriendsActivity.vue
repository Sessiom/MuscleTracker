      ...
      <div class="columns">
        ...
        <div v-if="show2">
          <article class="media box">
              ...
              <div class="content">
                ...
                <div class="columns">
                  <div class="column has-text-centered"
                    style="display: flex; justify-content: space-around; align-items: center;">
                    <div>
                      <div class="title" style="margin: 0px;">3696 ft</div>
                      <div class="heading">Distance</div>
                    </div>
                    <div>
                      <div class="title" style="margin: 0px;">0:30</div>
                  ...
                  <div class="column"><img
                      src="https://www.outsideonline.com/wp-content/uploads/2022/01/iStock_89170989_SMALL.jpg"
                      style="max-height: 100%;"></div>
                </div>
                </p>
              </div>
            ...
            <div class="media-right"><button @click="show2 = !show2" class="delete"></button></div>
          </article>
        </div>
        ...
        <div v-if="show3">
          <article class="media box">
              ...
              <div class="content">
                ...
                <div class="columns">
                  <div class="column has-text-centered"
                    style="display: flex; justify-content: space-around; align-items: center;">
                    <div>
                      <div class="title" style="margin: 0px;">1.2 mi</div>
                      <div class="heading">Distance</div>
                    </div>
                    <div>
                      <div class="title" style="margin: 0px;">0:45</div>
                      <div class="heading">Duration</div>
                    </div>
                  </div>
                  <div class="column"><img src="https://globalsportmatters.com/wp-content/uploads/2019/08/Walking.jpg"
                      style="max-height: 100%;"></div>
                </div>
                </p>
              </div>
            ...
            <div class="media-right"><button @click="show3 = !show3" class="delete"></button></div>
          </article>
        </div>
        ...
        <div v-if="show4">
          <article class="media box">
            ...
            <div class="media-content">
              <div class="content">
                <p><strong>Moshe Plotkin</strong> &nbsp;<small>@JewPaltz</small> &nbsp; <small>1 days ago</small><br>
                  Swam through the gunk - {
                  "lat": 41.7459,
                  "lng": -74.082
                  }
                <div class="columns">
                  <div class="column has-text-centered"
                    style="display: flex; justify-content: space-around; align-items: center;">
                    <div>
                      <div class="title" style="margin: 0px;">2112 ft</div>
                      <div class="heading">Distance</div>
                    </div>
                    <div>
                      <div class="title" style="margin: 0px;">0:30</div>
                  ...
                  <div class="column"><img
                      src="https://baltimorediary.typepad.com/.a/6a00d8341d75c753ef0120a611ca3c970c-pi"
                      style="max-height: 100%;"></div>
                </div>
                </p>
              </div>
            ...
            <div class="media-right"><button @click="show4 = !show4" class="delete"></button></div>
          </article>
        </div>
        ...
        <div v-if="show5">
          <article class="media box">
            ...
            <div class="media-content">
              <div class="content">
                <p><strong>Moshe Plotkin</strong> &nbsp;<small>@JewPaltz</small> &nbsp; <small>4 days ago</small><br>
                  Skated through campus - {
                  "lat": 41.7459793,
                  "lng": -74.082801
                  }
                <div class="columns">
                  <div class="column has-text-centered"
                    style="display: flex; justify-content: space-around; align-items: center;">
                    <div>
                      <div class="title" style="margin: 0px;">2640 ft</div>
                      <div class="heading">Distance</div>
                    </div>
                    <div>
                      <div class="title" style="margin: 0px;">0:30</div>
                  ...
                  <div class="column"><img
                      src="https://cdn.shopify.com/s/files/1/0018/8009/6838/files/ollie_8a8b4de1-dd7e-4667-b65a-d2fd07b221e0.png?v=1540868477"
                      style="max-height: 100%;"></div>
                </div>
                </p>
              </div>
            ...
            <div class="media-right"><button @click="show5 = !show5" class="delete"></button></div>
          </article>
        </div>
      </div>
    </div>
